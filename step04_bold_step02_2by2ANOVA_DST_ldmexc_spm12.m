...
outputdir='R:\qinproject\analysis20220409\glmgroupanalysisspm12B';
...
for i=1:length(experimentparts)
    allexpA1{i,1}=['R:\qinproject\analysis20220409\glmresults\',experimentparts{i,1},filesep,'fmri',filesep,'stats_spm8',filesep,'con_0001.nii,1'];
end
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(1).levels = [1
    1];
...
allexpA2=cell(1);
for i=1:length(experimentparts)
    allexpA2{i,1}=['R:\qinproject\analysis20220409\glmresults\',experimentparts{i,1},filesep,'fmri',filesep,'stats_spm8',filesep,'con_0002.nii,1'];
end
...
for i=1:length(controlparts)
    allexpB1{i,1}=['R:\qinproject\analysis20220409\glmresults\',controlparts{i,1},filesep,'fmri',filesep,'stats_spm8',filesep,'con_0001.nii,1'];
end
...
allexpB2=cell(1);
for i=1:length(controlparts)
    allexpB2{i,1}=['R:\qinproject\analysis20220409\glmresults\',controlparts{i,1},filesep,'fmri',filesep,'stats_spm8',filesep,'con_0002.nii,1'];
end
